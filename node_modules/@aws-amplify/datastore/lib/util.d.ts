...
import { ModelInstanceMetadata, PersistentModel, PersistentModelConstructor, PredicateObject, PredicatesGroup, RelationshipType, RelationType, ModelKeys, SchemaNamespace, SortPredicatesGroup } from './types';
...
export declare const processCompositeKeys: (attributes: {
    type: string;
