...
const defaultConfigBabelPreset = () => ({
  presets: [[// Supports nullish-coalescing, optional-chaining, optional-catch-binding, object-rest-spread, dynamic-import
  ...
  require('@babel/preset-env'), {
    ...
    modules: 'commonjs' // debug: true,

  }], // Support TypeScript
  require('@babel/preset-typescript')],
  plugins: [// Support static class properties.
