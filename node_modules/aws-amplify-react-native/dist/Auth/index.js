...
function withAuthenticator(Comp) {
  ...
  var federated = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var theme = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  var signUpConfig = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
  ...
  var Wrapper = /*#__PURE__*/function (_React$Component) {
    ...
    function Wrapper(props) {
      ...
      _this.handleAuthStateChange = _this.handleAuthStateChange.bind(_assertThisInitialized(_this));
      _this.state = {
      ...
      value: function render() {
        ...
        if (signedIn) {
          if (!this.authConfig.includeGreetings) {
            return /*#__PURE__*/_react["default"].createElement(Comp, _extends({}, this.props, {
              authState: authState,
              authData: authData,
          ...
          }, /*#__PURE__*/_react["default"].createElement(_Greetings["default"], {
            authState: authState,
            authData: authData,
            onStateChange: this.handleAuthStateChange,
            theme: theme,
            usernameAttributes: this.authConfig.usernameAttributes
          }), /*#__PURE__*/_react["default"].createElement(Comp, _extends({}, this.props, {
            authState: authState,
            authData: authData,
            onStateChange: this.handleAuthStateChange
          })));
        ...
        return /*#__PURE__*/_react["default"].createElement(_Authenticator["default"], _extends({}, this.props, {
